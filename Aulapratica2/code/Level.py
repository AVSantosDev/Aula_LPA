...
class Level:
    ...
    def run(self):
        ...
        clock = pygame.time.Clock() # definido a variavel relogio para controlar a velocidade da imagem
        while True:
            clock.tick(60)#chama o clock para passar o parametro de velocidade
